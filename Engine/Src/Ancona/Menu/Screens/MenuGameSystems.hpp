...
class MenuGameSystems : public ild::ScreenSystemsContainer
{
  public:
    ...
    /* getters and setters */
    ild::DrawableSystem &drawable()
    {
        return *_drawable;
    }
    ild::InputControlSystem &input()
    {
        return *_input;
    }
    ild::PositionSystem &position()
    {
        return *_position;
    }
    ild::ActionSystem &action()
    {
        return *_action;
    }
    ild::CameraSystem &camera()
    {
        return *_camera;
    }
    ild::CollisionSystem &collision()
    {
        return *_collision;
    }
    ild::SoundSystem &sound()
    {
        return *_sound;
    }
    ild::MusicSystem &music()
    {
        return *_music;
    }
    ild::AutoStartMusicSystem &autoStartMusic()
    {
        return *_autoStartMusic;
    }
    ButtonSystem &button()
    {
        return *_button;
    }
    ild::CollisionType nullCollision()
    {
        return 0;
    }
