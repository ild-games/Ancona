...
class MenuInputHandler : public ild::InputHandler
{
  public:
    ...
    virtual bool IsAnyFingerDown()
    {
        return false;
    };

    /* getters and setters */
    void systems(MenuGameSystems *systems)
    {
        _systems = systems;
    }
...
class MenuInputComponent : public ild::InputControlComponent
{
  public:
     ...
     */
    MenuInputComponent(MenuGameSystems &systems, std::shared_ptr<MenuInputHandler> inputHandler);
