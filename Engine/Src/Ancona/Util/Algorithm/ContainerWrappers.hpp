...
template <typename Container, typename UPredicate> bool all_of(Container &container, UPredicate pred)
{
    return std::all_of(container.begin(), container.end(), pred);
}

template <typename Container, typename UPredicate> bool any_of(Container &container, UPredicate pred)
{
    return std::any_of(container.begin(), container.end(), pred);
}

template <typename Container, typename UPredicate> bool none_of(Container &container, UPredicate pred)
{
...
template <class Container, class T> auto find(Container &c, T &v) -> decltype(c.begin())
{
    return std::find(c.begin(), c.end(), v);
}

template <class Container, class UPredicate> auto find_if(Container &c, UPredicate v) -> decltype(c.begin())
{
    return std::find_if(c.begin(), c.end(), v);
}

template <class Container, class UPredicate> auto find_if_not(Container &c, UPredicate v) -> decltype(c.begin())
{
    return std::find_if_not(c.begin(), c.end(), v);
}

template <class ContainerA, class ContainerB> auto find_end(ContainerA &a, ContainerB &b) -> decltype(a.begin())
{
...
template <class ContainerA, class ContainerB> auto find_first_of(ContainerA &a, ContainerB &b) -> decltype(a.begin())
{
...
template <class Container> auto adjacent_find(Container &container) -> decltype(container.begin())
{
...
auto count(Container &container, const T &val) ->
...
auto count_if(Container &container, UPredicate pred) ->
    typename std::iterator_traits<decltype(container.begin())>::difference_type
{
...
template <class ContainerA, class ContainerB> bool equal(ContainerA &a, ContainerB &b)
{
...
template <class ContainerA, class ContainerB> bool is_permutation(ContainerA &a, ContainerB &b)
{
...
template <class ContainerA, class ContainerB> auto search(ContainerA &a, ContainerB &b) -> decltype(a.begin())
{
...
template <class Container, class Compare> void sort(Container &container, Compare comp)
{
    std::sort(container.begin(), container.end(), comp);
}

template <class Container, class T> auto remove(Container &container, const T &value) -> decltype(container.begin())
{
