...
class TextDrawable : public Drawable
{
  public:
     ...
     */
    TextDrawable(const std::string &text, const std::string &fontKey, const Color color, const int characterSize,
                 const float priority, const std::string &key, float priorityOffset = 0,
                 Vector2f anchor = Vector2f(0.0f, 0.0f), bool smooth = true);
