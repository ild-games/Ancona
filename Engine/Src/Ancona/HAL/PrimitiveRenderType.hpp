// Altered SFML PrimitiveType.hpp for Ancona's HAL abstraction layer
...
#ifndef Ancona_HAL_PrimitiveRenderType_H_
#define Ancona_HAL_PrimitiveRenderType_H_
...
#endif // Ancona_HAL_PrimitiveRenderType_H_
