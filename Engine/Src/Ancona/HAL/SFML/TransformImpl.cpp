...
ild::Transform priv::TransformImpl::TranslateSfmlToAncona(const sf::Transform &transform)
{
    ...
    ild::Transform ildTransform(matrix[0], matrix[4], matrix[12], matrix[1], matrix[5], matrix[13], matrix[3],
                                matrix[7], matrix[15]);
...
sf::Transform priv::TransformImpl::TranslateAnconaToSfml(const ild::Transform &transform)
{
    ...
    sf::Transform sfmlTransform(matrix[0], matrix[4], matrix[12], matrix[1], matrix[5], matrix[13], matrix[3],
                                matrix[7], matrix[15]);
