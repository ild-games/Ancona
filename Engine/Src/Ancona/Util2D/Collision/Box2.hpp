...
class Box2
{
  public:
     ...
     */
    Box2(const Vector2f &position = Vector2f(), const Vector2f &dimension = Vector2f(),
         const Vector2f &anchor = Vector2f(), const float &rotation = 0.0f);
    ...
    void dimension(float x, float y)
    {
        Dimension.x = x;
        Dimension.y = y;
    };
