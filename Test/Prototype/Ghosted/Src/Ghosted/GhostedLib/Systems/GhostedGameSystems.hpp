#ifndef Ghosted_Systems_GhostedGameSystems_H_
#define Ghosted_Systems_GhostedGameSystems_H_
...
/**
 * @brief Game systems used by Ghosted
 */
class GhostedGameSystems : public ScreenSystemsContainer
{
    public:
        /**
         * @brief Constructs the game systems for Ghosted
         *
         * @param screenManager Screen Manager for the game.
         */
        GhostedGameSystems(ScreenManager & screenManager);
