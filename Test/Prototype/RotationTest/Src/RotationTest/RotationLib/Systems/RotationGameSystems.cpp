#include "RotationGameSystems.hpp"

using namespace ild;

RotationGameSystems::RotationGameSystems(ScreenManager & screenManager) :
    ScreenSystemsContainer(screenManager, 0)
{
    ...
    _rotate = ConstructSystem<RotateSystem>("rotate", *_systemManager);
